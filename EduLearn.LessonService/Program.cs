...
// ── Database: EduLearn_Lesson PostgreSQL ──────────────────────────────────────
builder.Services.AddDbContext<LessonDbContext>(options =>
    options.UseNpgsql(
        builder.Configuration.GetConnectionString("LessonDb"),
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title       = "EduLearn Lesson Service",
        Version     = "v1",
        Description = "Lesson content management, ordering, preview access and Azure Blob content delivery"
    });
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "EduLearn Lesson Service v1");
